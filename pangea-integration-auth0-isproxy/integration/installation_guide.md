...
2. When you create your token in the guide, make sure it also has access to both IP Intel 
...
1. Configure the integration using the following fields:
   ...
   * PROVIDER - The selected provider for IP Intel "Is Proxy" endpoint (e.g. digitalenvoy)
...
Once the Action is added, Pangea APIs will be used to perform ip proxy checks on new user account creation flows.
